...
var PriestMonster = Monster{Name: "Priest", Level: 5, MonsterAlignment: LawfulAlignment, Move: "", Attack: "spell", Page: "243", StatBlock: "AC 15 (chainmail + shield), HP 23, ATK 2 mace +3 (1d6) or 1 spell +3, MV near, S +1, D +0, C +1, I +0, W+2, Ch +1, AL L, LV 5", Tags: []MonsterTag{HumanoidTag}}
...
var ThiefMonster = Monster{Name: "Thief", Level: 3, MonsterAlignment: NeutralAlignment, Move: "", Attack: "", Page: "259", StatBlock: "AC 13 (leather), HP 13, ATK 1 dagger (close/near) +2 (1d4) or 1 shortsword +0 (1d6), MV near, S+0, D +2, C +0, I +0, W +0, Ch +1, AL N, LV 3", Tags: []MonsterTag{HumanoidTag}}
